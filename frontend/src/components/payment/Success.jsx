    ...
    return (
        <div className="max-w-xl w-full mx-auto bg-gray-900 rounded-xl overflow-hidden">
            ...
            <div className="pt-5 pb-6 px-6 text-right bg-gray-800 -mb-2">
               <a href="#" className="inline-block w-full sm:w-auto py-3 px-5 mb-2 text-center font-semibold leading-6 text-blue-50 bg-green-500 hover:bg-green-600 rounded-lg transition duration-200">Confirm</a>
            </div>
        </div>
    );
}
